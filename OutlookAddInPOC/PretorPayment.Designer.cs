...
namespace OutlookAddInPOC {
    ...
    public sealed partial class PretorPayment : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        public PretorPayment(global::Microsoft.Office.Tools.Outlook.Factory factory, global::System.IServiceProvider serviceProvider) : 
    ...
    internal sealed partial class Globals {
        ...
        private static PretorPayment _PretorPayment;
        ...
        internal static PretorPayment PretorPayment {
            get {
                return _PretorPayment;
            }
            set {
                if ((_PretorPayment == null)) {
                    _PretorPayment = value;
                }
                else {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.PretorPayment.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionCollectionBase {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return ((WindowFormRegionCollection)(Globals.PretorPayment.GetFormRegions(explorer, typeof(WindowFormRegionCollection))));
            }
        }
        
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Inspector inspector] {
            get {
                return ((WindowFormRegionCollection)(Globals.PretorPayment.GetFormRegions(inspector, typeof(WindowFormRegionCollection))));
            }
        }
    }
